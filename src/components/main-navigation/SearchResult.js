...
const SearchResult = (props) => {
    ...
    return (
        <>
        <Link to={`/games/${props.id}`} onClick={()=>props.onClick(false)}>
            <div className="flex items-center mb-2">
                <div className="min-w-[5rem]">
                    <img src={props.image? props.image:noCoverUrl} alt={props.image} className="w-16 h-16 ml-1 mr-4 rounded-md mt-2" />
                </div>
